        ...
        if is_image(filename):
            ...
            with Image.open(os.path.join(args.directory, filename)) as image:
                ...
                if exif_dict is None:
                    ...
                    skip_count += 1
                    print(f"\033[33m\u25E6 Skipped file {new_filename}\033[0m")
                else:
                    ...
                    if os.path.exists(new_file_path):
                        skip_count += 1
                        print(f"\033[31m\u25E6 WARN: Filename already exists: {new_file_path}\033[0m")
                    else:
                        ...
                        if args.move:
                            ...
                            if os.path.exists(output_path):
                                ...
                                print(f"\033[36m\u25E6 OK: Moved {new_filename} to {args.move}\033[0m")

            # Increment image count
            image_count += 1
            
            # Print progress and image count
            print(f"\033[32m\u25E6 Processed {image_count} of {image_total} images.\033[0m")
        
    # Print skipped image count
    print(f"\033[36mTotal: {image_total}\033[0m")
    print(f"\033[36mSkipped: {skip_count}\033[0m")
    print(f"\033[36mDeleted: {dupe_count}\033[0m")
